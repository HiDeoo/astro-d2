...
2. You will also need to have D2 installed.
   ...
   Alternatively, you can use the [`experimental.useD2js` configuration option](/configuration/#used2js) to use [D2.js](https://www.npmjs.com/package/@d2lang/d2) to generate diagrams instead of the D2 binary.
